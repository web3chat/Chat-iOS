...
//    isIPhoneXSeries ? LAPolicyDeviceOwnerAuthenticationWithBiometrics: LAPolicyDeviceOwnerAuthentication
    if (@available(iOS 9.0, *)) {
        if ([context canEvaluatePolicy:isIPhoneXSeries ? LAPolicyDeviceOwnerAuthenticationWithBiometrics: LAPolicyDeviceOwnerAuthentication error:&error]) {
            [context evaluatePolicy:isIPhoneXSeries ? LAPolicyDeviceOwnerAuthenticationWithBiometrics: LAPolicyDeviceOwnerAuthentication localizedReason:describe reply:^(BOOL success, NSError * _Nullable error) {
