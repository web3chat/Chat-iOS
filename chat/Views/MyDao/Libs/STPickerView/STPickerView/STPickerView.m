...
- (void)showWithView:(UIView *)view
{
    ...
    [self setCenter:[PWUtils getKeyWindowWithView:view].center];
    [[PWUtils getKeyWindowWithView:view] bringSubviewToFront:self];
...
- (void)setTitleFont:(UIFont *)titleFont
{
    ...
    [self.buttonLeft.titleLabel setFont:titleFont];
    [self.buttonRight.titleLabel setFont:titleFont];
...
- (UIView *)contentView
{
    if (!_contentView) {
        ...
        [_contentView setBackgroundColor:SGColorFromRGB(0x262b31)];
...
- (UIButton *)buttonLeft
{
    if (!_buttonLeft) {
        ...
        [_buttonLeft setTitleColor:SGColorFromRGB(0xc8d3de) forState:UIControlStateNormal];
        [_buttonLeft.titleLabel setFont:self.titleLabel.font];
...
- (UIButton *)buttonRight
{
    if (!_buttonRight) {
        ...
        [_buttonRight setTitle:@"完成" forState:UIControlStateNormal];
        [_buttonRight setTitleColor:SGColorFromRGB(0xc8d3de) forState:UIControlStateNormal];
        [_buttonRight.titleLabel setFont:self.titleLabel.font];
...
- (UILabel *)labelTitle
{
    if (!_labelTitle) {
        ...
        [_labelTitle setTextColor:SGColorFromRGB(0xc8d3de)];
        [_labelTitle setFont:self.titleLabel.font];
