...
- (void)setupUI
{
    ...
    _widthPickerComponent = kScreenWidth - 30;
    self.pickerView.backgroundColor = SGColorFromRGB(0xffffff);
    self.contentView.backgroundColor = SGColorFromRGB(0xF8F8F8);
    
    self.titleColor = SGColorFromRGB(0x24374E);
...
- (UIView *)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(nullable UIView *)view
{
    ...
    else if (component == 1)
    {
        ...
        label.textColor = SGColorFromRGB(0x24374E);
        return label;
    }else
    {
        UILabel *label = [[UILabel alloc]init];
